...
plot(times, data$totalN, 'l', main = "Total Nitrogen",xlab = "Time", ylab = "g N")
plot(times, data$totalAN, 'l', main = "Available Nitrogen",xlab = "Time", ylab = "g N")
plot(times, data$totalON, 'l', main = "Organic Nitrogen",xlab = "Time", ylab = "g N")
plot(times, data$totalLN, 'l', main = "Litter Nitrogen",xlab = "Time", ylab = "g N")
plot(times, data$totalP, 'l', main = "Total Phosphorus",xlab = "Time", ylab = "g P")
plot(times, data$totalAN, 'l', main = "Available Phosphorus",xlab = "Time", ylab = "g P")
plot(times, data$totalOP, 'l', main = "Organic Phosphorus",xlab = "Time", ylab = "g P")
plot(times, data$totalLP, 'l', main = "Litter Phosphorus",xlab = "Time", ylab = "g P")



layout_matrix_biomass <- matrix(1:2, nr = 1, ncol = 2)
layout(layout_matrix_biomass)
plot(times, data$nonFixerN*wN1, 'l', main = "Non-Fixer Biomass",xlab = "Time", ylab = "g C")
plot(times, data$fixerN*wP1, 'l', main = "Fixer Biomass",xlab = "Time",ylab = "g C")